...
imagem_final_7[:int(linha / 2), :int(coluna / 2)] = aplicar_filtro_passa_alta(quadrante_ruido_1, 0.07)
imagem_final_7[:int(linha / 2), int(coluna / 2):] = aplicar_filtro_passa_alta(quadrante_ruido_2, 0.07)
imagem_final_7[int(linha / 2):, :int(coluna / 2)] = aplicar_filtro_passa_alta(quadrante_ruido_3, 0.07)
imagem_final_7[int(linha / 2):, int(coluna / 2):] = aplicar_filtro_passa_alta(quadrante_ruido_4, 0.07)
...
imagem_final_13[:int(linha / 2), :int(coluna / 2)] = aplicar_filtro_passa_alta(quadrante_ruido_1, 0.13)
imagem_final_13[:int(linha / 2), int(coluna / 2):] = aplicar_filtro_passa_alta(quadrante_ruido_2, 0.13)
imagem_final_13[int(linha / 2):, :int(coluna / 2)] = aplicar_filtro_passa_alta(quadrante_ruido_3, 0.13)
imagem_final_13[int(linha / 2):, int(coluna / 2):] = aplicar_filtro_passa_alta(quadrante_ruido_4, 0.13)

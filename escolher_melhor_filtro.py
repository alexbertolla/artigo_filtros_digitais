...
caminho_resultado_metodo = './resultado_metodo/'
caminho_resultado_metodo_pa = './resultado_metodo/imagens_passa_alta/'
caminho_resultado_metodo_pb = './resultado_metodo/imagens_passa_baixa/'
caminho_resultado_metodo_imagens_finais = './resultado_metodo/imagens_finais/'
